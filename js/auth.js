...
// ==================== [ FIX 2a: SESSION RESTORE & POST-LOGIN ] ====================

// Helper function: Manages post-login/session restoration UI updates and data loading
function afterLoginSuccess() {
    showAlert('Login successful!', 'success');
    document.getElementById('loginScreen').style.display = 'none';
    document.getElementById('appContainer').style.display = 'flex'; 

    // **Fix for Issue 3 is integrated here: Load customers immediately**
    ...
    // Check connection, apply permissions, etc. (Keep your existing post-login logic here)
    // ...
}

// New Function: Check and restore Supabase session
async function checkAndRestoreSession() {
    // Assuming initializeSupabase is defined in supabase.js
    const client = initializeSupabase();
    ...
    try {
        ...
        // Session found, set global user data (assuming this code exists in your app)
        const user = data.session.user;
        // Fetch role/name from personnel table
        ...
        // ... (Keep your role/name UI update code here) ...

        console.log('✅ Session restored for user:', currentUser.email);
        afterLoginSuccess(); // Update UI after successful session restoration
        return true;
